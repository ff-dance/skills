#!/usr/bin/env python3
"""Unified CLI for editable-ppt image generation or editing.
...
def _cli_reinstall_hint() -> str:
    return "`pipx install --force --editable <path-to-editable-ppt>/cli`"
...
def _dependency_hint(package: str, *, upgrade: bool = False) -> str:
    ...
    return (
        "Install editable-ppt with pipx so CLI dependencies are installed, for example "
...
asset sheets, and batch image jobs in editable-ppt runs.
""",
