...
CLI_DIR = ROOT / "skills/editable-ppt/cli"
RUNTIME_DIR = CLI_DIR / "editppt/runtime"
PROMPT_SCRIPT = ROOT / "skills/editable-ppt/scripts/build-page-worker-prompt.py"
...
class MultiAgentBackendTest(unittest.TestCase):
    ...
    def test_skill_prompt_script_output_is_accepted_by_dispatch(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn(str(ROOT / "skills/editable-ppt/references/page-decision-tree.md"), prompt_text)
