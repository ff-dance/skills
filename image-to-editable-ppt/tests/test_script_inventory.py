...
RUNTIME_DIR = ROOT / "skills/editable-ppt/cli/editppt/runtime"
SKILL_SCRIPT_DIR = ROOT / "skills/editable-ppt/scripts"
LEGACY_ENTRYPOINTS = {
    "prepare_inputs.py",
...
SCAN_ROOTS = [
    ROOT / "README.md",
    ROOT / "README_en.md",
    ROOT / "skills/editable-ppt/SKILL.md",
    ROOT / "skills/editable-ppt/references",
    ROOT / "skills/editable-ppt/prompts",
    RUNTIME_DIR,
]
