...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "model.azure_openai_temperature": "azure_openai_temperature",
    ...
    "model.optimizer_azure_openai_temperature": "optimizer_azure_openai_temperature",
    ...
    "model.target_azure_openai_temperature": "target_azure_openai_temperature",
